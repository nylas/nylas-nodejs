(function() {
  var Account, Attributes, Calendar, Contact, Delta, Draft, Event, File, Folder, Label, ManagementModelCollection, Message, NylasConnection, Promise, RestfulModel, RestfulModelCollection, Tag, Thread, _, clone, request;
