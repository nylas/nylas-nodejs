(function() {
  ...
  Nylas = (function() {
    ...
    Nylas.urlForAuthentication = function(options) {
      ...
      return this.apiServer + "/oauth/authorize?client_id=" + this.appId + "&trial=" + options.trial + "&response_type=code&scope=email&login_hint=" + options.loginHint + "&redirect_uri=" + options.redirectURI  + '&state=' + options.state;
    };
