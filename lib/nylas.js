(function() {
  var Delta, ManagementAccount, ManagementModelCollection, Nylas, NylasConnection, Promise, RestfulModelCollection, _, request;
  ...
  Nylas = (function() {
    ...
    Nylas.revokeToken = function(accessToken, callback) {
      if (!accessToken) {
        throw new Error("Please provide the accessToken you want to revoke");
      }
      return new Promise((function(_this) {
        return function(resolve, reject) {
          var options;
          options = {
            ...
            url: _this.apiServer + "/oauth/revoke"
          };
