(function() {
  var ManagementAccount, Nylas, NylasConnection, Promise, RestfulModelCollection, _, request;
  ...
  Nylas = (function() {
    ...
    Nylas.config = function(arg) {
      ...
      if (this.hostedAPI()) {
        ...
        this.accounts = new RestfulModelCollection(ManagementAccount, conn, this.appId);
      }
      return this;
    };
