...
// Create a comprehensive test runner that runs all 25 tests
...
async function runComprehensiveJestTestsInCloudflare() {
  ...
  try {
    ...
    const response = await fetch('http://localhost:8801/test');
...
async function main() {
  ...
  const success = await runComprehensiveJestTestsInCloudflare();
