...
const replacements = [
  ...
  {
    pattern: /import\s+{\s*enableFetchMocks\s*}\s+from\s+['"]jest-fetch-mock['"];?/g,
  ...
  {
    pattern: /^describe\(/gm,
    replacement: "import { describe, it, expect, beforeEach, beforeAll, afterEach, afterAll, vi } from 'vitest';\n\ndescribe("
  },
