...
* Add support for binding backend frameworks directly using the Nylas SDK to handle webhooks events and authentication
* Add support for Express.js as a bindable backend framework
